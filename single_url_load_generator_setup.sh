#!/bin/bash
username=lovishchopra
instance_name=load-gen-single-url
...
gcloud compute scp --recurse --compress main_startup.sh ./consistent_web_main ./single_url_load_generator $instance_name:/home/$username
