...
gcloud compute instances create "$instance_name" --machine-type=n1-standard-64 --image-family=debian-10 --image-project=debian-cloud --zone=us-west4-a --tags=http-server
